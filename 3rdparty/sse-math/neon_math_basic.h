...
#ifndef NEON_MATH_BASIC_H_
#define NEON_MATH_BASIC_H_
...
inline v4sf exp_ps(v4sf x) {
    ...
    static const float cephes_exp_p[6] = {c_cephes_exp_p0, c_cephes_exp_p1, c_cephes_exp_p2, c_cephes_exp_p3,
