...
#ifndef CONTROLLER_SENTRY_HIGHER_DEBUG_H_
#define CONTROLLER_SENTRY_HIGHER_DEBUG_H_
 ...
 */
class ControllerSentryHigherDebug{
public:
    /**
...
#endif //CONTROLLER_SENTRY_HIGHER_DEBUG_H_
