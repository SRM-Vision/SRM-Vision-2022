...
bool Compensator::Initialize(std::string robot_name) {
    ...
    config_["A0"] >> offset0d_[0];config_["B0"] >> offset0d_[1];config_["C0"] >> offset0d_[2];config_["D0"] >> offset0d_[3];
    config_["A1"] >> offset0p_[0];config_["B1"] >> offset0p_[1];config_["C1"] >> offset0p_[2];config_["D1"] >> offset0p_[3];
    config_["AA0"] >> offset1d_[0];config_["BB0"] >> offset1d_[1];config_["CC0"] >> offset1d_[2];config_["DD0"] >> offset1d_[3];
    config_["AA1"] >> offset1p_[0];config_["BB1"] >> offset1p_[1];config_["CC1"] >> offset1p_[2];config_["DD1"] >> offset1p_[3];
    config_["AAA0"] >> offset2d_[0];config_["BBB0"] >> offset2d_[1];config_["CCC0"] >> offset2d_[2];config_["DDD0"] >> offset2d_[3];
    config_["AAA1"] >> offset2p_[0];config_["BBB1"] >> offset2p_[1];config_["CCC1"] >> offset2p_[2];config_["DDD1"] >> offset2p_[3];
    return true;
}
